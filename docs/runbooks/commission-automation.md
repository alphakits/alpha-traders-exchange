...
- `ALPHA_EXCHANGE_ETHERSCAN_API_KEY`: existing key must include BSC chain 56 history access; an unsupported/free plan is reported as `bep20_index_unavailable`. Submitted BEP20 TxID verification remains independent of this index.
