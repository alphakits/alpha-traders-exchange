...
| How are sellers admitted? | “Seller access is restricted. Before approval, an authorized owner or administrator must attest that they reviewed a government-issued identity document, matched the applicant in a live identity video, confirmed ownership of the application contact, and confirmed acceptance of the marketplace rules. The server records the reviewer, time, method, and four completed checks; raw identity documents and videos are kept out of the Exchange application record. Only an approved seller can submit a listing, and listings also require administrative review.” | Live role gates, server-recorded approval attestation, current written vetting procedure, redacted aggregate evidence | Operations/compliance; source enforced, operating procedure and retention still require reconciliation |
