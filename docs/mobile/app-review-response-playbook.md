...
| How are sellers admitted? | “Seller access is restricted. Applicants submit the application on the website. The owner reviews the identity document and video through WhatsApp, then an authorized owner or administrator approves or rejects the application on the website. The server retains the approval decision and audit trail; raw identity documents and videos are kept out of the Exchange application record. Only an approved seller can submit a listing, and listings also require administrative review.” | Live role gates, ordinary admin approval audit trail, current written vetting procedure, redacted aggregate evidence | Operations/compliance; source enforced, operating procedure and retention still require reconciliation |
