...
export const privacyContent = {
  en: {
    ...
    sections: [
      ...
      { title: "Registration contact number", paragraphs: ["New registrations require a WhatsApp contact number so the Alpha Traders owner and authorized support team can contact you about your account, support requests, and marketplace safety. Providing a number does not verify ownership or enable optional WhatsApp notifications. The number is not public by default."] },
      ...
      { title: "Seller identity review", paragraphs: ["Seller applicants may be asked to present a government-issued identity document and a live identity video through an official review channel designated for that case. The applicant should be told the channel, purpose, and applicable retention terms before sending sensitive media. The Exchange account record stores the authorized reviewer, time, method, and completed review checks rather than raw identity media. Do not upload identity documents or identity videos to a public profile, Trade Room, Discord, or an unsolicited message."] },
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "رقم التواصل عند التسجيل", paragraphs: ["يتطلب التسجيل الجديد رقم واتساب للتواصل حتى يتمكن مالك Alpha Traders وفريق الدعم المخوّل من التواصل معك بشأن الحساب وطلبات الدعم وسلامة السوق. تقديم الرقم لا يُثبت ملكيته ولا يفعّل إشعارات واتساب الاختيارية. لا يظهر الرقم للعامة افتراضيًا."] },
...
export const termsContent = {
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "3. اعتماد البائع", paragraphs: ["يمكن فقط للبائعين الذين سجّل مراجع مخول ضوابط مراجعتهم المطلوبة نشر العروض. تشمل الضوابط وثيقة هوية حكومية، ومطابقة الشخص في فيديو مباشر، وملكية وسيلة التواصل المستخدمة في الطلب، وقبول قواعد السوق. الاعتماد صلاحية استخدام قابلة للسحب، وليس ضمانًا للسلوك المستقبلي أو الملاءة أو الربح أو صفقة بلا مخاطر."] },
