...
import { canPublishListings, getMyMarketplaceListings, getSellerListingWorkspaceSummary } from "@/lib/alpha-exchange-store";
...
export async function GET(request: NextRequest) {
  ...
  if (!canPublishListings(user)) {
    return NextResponse.json({ listings: [], summary: null });
  }
