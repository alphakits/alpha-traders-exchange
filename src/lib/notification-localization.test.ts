...
describe("notification localization", () => {
  const exactMessageCases = [
    ...
    ["Your meeting is ready. After handing over the cash, confirm it in the Trade Room. No photo is required.", "موعد اللقاء جاهز. بعد تسليم النقد، أكد ذلك في غرفة الصفقة. لا يلزم رفع صورة."],
    ["Your Cardless ATM trade is active. Send the withdrawal code, then confirm it in the Trade Room. No photo is required.", "صفقة السحب دون بطاقة نشطة. أرسل رمز السحب ثم أكد ذلك في غرفة الصفقة. لا يلزم رفع صورة."],
    ["Buyer sent the cardless withdrawal code. Collect the ATM cash, then confirm receipt in the Trade Room.", "أرسل المشتري رمز السحب دون بطاقة. اسحب النقد من الصراف ثم أكد الاستلام في غرفة الصفقة."],
    ["Buyer confirmed the cash was handed over. Confirm receipt before sending USDT.", "أكد المشتري تسليم النقد. أكد الاستلام قبل إرسال USDT."],
    ["Confirm completion after sending USDT. Only you can close this trade, and no photo is required.", "أكد الإكمال بعد إرسال USDT. أنت وحدك تستطيع إغلاق هذه الصفقة، ولا يلزم رفع صورة."],
    ...
    ["Seller confirmed cash was collected from the cardless ATM. Your wallet is now visible to the seller for the USDT transfer.", "أكد البائع سحب النقد من الصراف دون بطاقة. أصبحت محفظتك ظاهرة للبائع الآن لتحويل USDT."],
    ["Seller confirmed in-person payment was received.", "أكد البائع استلام الدفعة وجهًا لوجه."],
    ["Seller confirmed in-person cash was received. Your wallet is now visible to the seller for the USDT transfer.", "أكد البائع استلام النقد وجهًا لوجه. أصبحت محفظتك ظاهرة للبائع الآن لتحويل USDT."],
  ...
  const dynamicMessageCases = [
    ...
    ["Seller marked the in-person exchange complete. The trade is now in history and review.", "أنهى البائع التبادل وجهًا لوجه. انتقلت الصفقة إلى السجل والتقييم."],
    ["Seller marked the cash and USDT exchange complete. The trade is in review; check your commission due.", "أنهى البائع تبادل النقد وUSDT. الصفقة قيد التقييم؛ تحقق من العمولة المستحقة."],
