...
- Name: auth.spec.ts >> Guest access >> protected route /en/dashboard redirects to login
- Location: e2e\auth.spec.ts:53:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/dashboard
Call log:
