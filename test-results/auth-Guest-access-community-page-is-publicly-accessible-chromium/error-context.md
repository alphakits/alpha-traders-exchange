...
- Name: auth.spec.ts >> Guest access >> community page is publicly accessible
- Location: e2e\auth.spec.ts:79:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/community
Call log:
  - navigating to "http://localhost:3000/en/community", waiting until "load"
