...
- Name: auth.spec.ts >> Guest access >> about-founder page is publicly accessible
- Location: e2e\auth.spec.ts:74:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/about-founder
Call log:
  - navigating to "http://localhost:3000/en/about-founder", waiting until "load"
