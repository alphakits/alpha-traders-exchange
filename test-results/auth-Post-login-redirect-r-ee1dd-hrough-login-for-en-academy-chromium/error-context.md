...
- Name: auth.spec.ts >> Post-login redirect >> redirectTo preserved through login for /en/academy
- Location: e2e\auth.spec.ts:135:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/academy
Call log:
  - navigating to "http://localhost:3000/en/academy", waiting until "load"
