...
- Name: auth.spec.ts >> Guest access >> protected route /en/profile redirects to login
- Location: e2e\auth.spec.ts:58:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/profile
Call log:
  - navigating to "http://localhost:3000/en/profile", waiting until "load"
