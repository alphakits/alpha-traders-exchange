...
for(const args of [
 ['--experimental-strip-types','--test','scripts/check-commission-checkout.mjs','scripts/check-commission-checkout-recovery.mjs'],
 ['./node_modules/vitest/vitest.mjs','run','src/lib/commission-checkout-reservations.test.ts','src/lib/commission-checkout-runtime.test.ts','src/app/api/alpha-exchange/commissions/checkout/route.test.ts','src/app/api/cron/commission-checkout/route.test.ts','src/components/sections/usdt-exchange/commission-checkout-panel.test.tsx'],
]) {
